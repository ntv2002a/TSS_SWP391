                        ...
                        <div class="table-responsive">
                            <form method="post" action="AddEval">
                                <div class="row" style="width: 100%">
                                    <div class="col-md-6">
                                        <label>Mile StoneId(Can't change)</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" value="${e.evalWeight}" class="form-control" name="evalWeight" >
                                    </div>
                                    <div class="col-md-6">
                                        <label>Max Loc</label>
                                        <input type="number" value="${e.maxLoc}" class="form-control" name="maxLoc" >
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-3">
                                        <button type="submit" class="btn btn-primary" style="margin: 10px;">Add new</button>
                                    </div>
                                    <div class="col-md-6">
                                    </div>
                                </div>
